...
<body>
    <div style="background-color: #3498db; color: #fff; text-align: center; padding: 20px;">
        ...
        <p style="font-size: 18px;">Here are some common questions and answers.</p>
    </div>

    <div style="padding: 20px;">
        <h2>Question 1</h2>
        <p style="font-size: 16px;"><strong>Q:</strong> What is your ig account?</p>
        <p style="font-size: 16px;"><strong>A:</strong> Please click this <a href="returns.php">@mk_abular</a></p>
    </div>
